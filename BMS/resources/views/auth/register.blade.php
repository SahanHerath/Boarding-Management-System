                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('nicno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nicno" type="text" class="form-control" name="nicno" value="{{ old('nicno') }}"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('contactno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contactno" type="text" class="form-control" name="contactno" value="{{ old('contactno') }}"  autofocus>
