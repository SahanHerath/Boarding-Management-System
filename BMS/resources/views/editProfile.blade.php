                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('user.update',$user->id)}}">
                        ...
                        <div class="form-group{{ $errors->has('nicno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nicno" type="text" class="form-control" name="nicno" value="{{ $user->nicno }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('contactno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contactno" type="text" class="form-control" name="contactno" value="{{ $user->contactno }}" autofocus>
