        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-custom">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <a class="navbar-brand" href="{{ url('/') }}"><img class="logo-img" style="width:30px; height:36px; float:left; border-radius:55%; " src="../assets/images/BMS.png" >
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li><a href="{{ route('login') }}"><p class="text-white">Login</p></a></li>
                            <li><a href="{{ route('register') }}"><p class="text-white">Register</p></a></li>
                     
                        @else
                        @if(Auth::user()->admin == 1)
                        <li><a href="/home"><p class="text-white">Home</p></a></li>
                        <li><a href="{{url('/Profile')}}"><p class="text-white">Profile</p></a></li>
                        @else
                        <li><a href="/home" ><p class="text-white">Home</p></a></li>
                        <li><a href="{{url('/Profile')}}"  v-pre style="position:relative; padding-left:50px;"><p class="text-white"><img src="/uploads/profilepics/{{Auth::user()->profilepic}}" style="width:32px; height:32px; position:absolute; top:10px; left:10px; border-radius:50%">{{ Auth::user()->name }}</p></a></li>
                        <!-- <li><a class="nav-link" href="/home"><p class="text-white">&nbspHome</p></a></li>
                        <li><a class="nav-link" href="{{url('/Profile')}}"><p class="text-white">&nbspProfile</p></a></li> -->
