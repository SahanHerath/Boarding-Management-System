                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nicno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nicno" type="text" class="form-control" name="nicno" value="<?php echo e(old('nicno')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('contactno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="contactno" type="text" class="form-control" name="contactno" value="<?php echo e(old('contactno')); ?>" required autofocus>
