    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-3 col-md-5 col-sm-12 col-12">
            ...
            <div class="card-body border-top ">
                ...
                <a href="<?php echo e(URL('/changePassword'.$user->id)); ?>" title="change password"><button class="btn btn-primary" >Change Password</button></a>
                    ...
                    <div class="card">
                        ...
                        <div  class="border-top card-footer p-0">
                            <div class="campaign-metrics d-xl-inline-block">
                                ...
                                <input class="btn btn-rounded btn-danger" type ="Submit" value = "Delete" >
                                </p>
                                </form>
                            </div>
...
<a href="<?php echo e(URL('/deactivateAccount'.$user->id)); ?>" title="deactivate account"><button class="btn btn-danger offset-10" >Deactivate Account</button></a>
