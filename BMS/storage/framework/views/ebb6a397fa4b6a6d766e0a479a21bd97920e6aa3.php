                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('boarding.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('number_of_boarders') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="number_of_boarders" type="number" class="form-control" name="number_of_boarders" value="<?php echo e(old('number_of_boarders')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12" layout="row">
                                ...
                                <div class="form-group<?php echo e($errors->has('Attached_washroom') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Attached_washroom" type="number" class="form-control" name="Attached_washroom" value="<?php echo e(old('Attached_washroom')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Washrooms') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Washrooms" type="number" class="form-control" name="Washrooms" value="<?php echo e(old('Washrooms')); ?>" >
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Bedrooms') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Bedrooms" type="number" class="form-control" name="Bedrooms" value="<?php echo e(old('Bedrooms')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Kitchen') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Kitchen" type="number" class="form-control" name="Kitchen" value="<?php echo e(old('Kitchen')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Chairs') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Chairs" type="number" class="form-control" name="Chairs" value="<?php echo e(old('Chairs')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Tables') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Tables" type="number" class="form-control" name="Tables" value="<?php echo e(old('Tables')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Fans') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Fans" type="number" class="form-control" name="Fans" value="<?php echo e(old('Fans')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Cupboards') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="Cupboards" type="number" class="form-control" name="Cupboards" value="<?php echo e(old('Cupboards')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Double_Beds') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="DoubleBed" type="number" class="form-control" name="Double_Beds" value="<?php echo e(old('Double_Beds')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('Single_Beds') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <input id="SingleBed" type="number" class="form-control" name="Single_Beds" value="<?php echo e(old('Single_Beds')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('rent') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="rent" type="number" class="form-control" name="rent" value="<?php echo e(old('rent')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('main_pic') ? ' has-error' : ''); ?>">
                            <div class="form-group row" >
                                <center><label for="main_pic" class="col-md-4 control_label "><?php echo e(('Main Boarding Picture')); ?></label></center>
                            ...
                            <div class="form-group row" >
                                <center><label for="boarding_pics" class="col-md-4 control_label "><?php echo e(('Other Boarding Pictures')); ?></label></center>
