                    ...
                    <nav class="navbar navbar-expand-lg fixed-top navbar-custom">
                        ...
                        <div class="collapse navbar-collapse " id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto navbar-right-top">
                                ...
                                <li class="nav-item"> 
                                    <a  style="color:#FFFFFF;" class="nav-link" href="<?php echo e(url('/TopRated')); ?>" id="navbarDropdown" role="button"  aria-haspopup="true" ><i class="fas fa-star"></i>&nbspTop Rated</a> 
                                </li>
