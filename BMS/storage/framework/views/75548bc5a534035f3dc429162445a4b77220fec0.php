        ...
        <div class="dashboard-main-wrapper">
                ...
                <div class="dashboard-header">
                    <nav class="navbar navbar-expand-lg fixed-top navbar-custom">
                        <a class="navbar-brand" href="index.html"><img src="assets/images/logo.png" width="30px"></a>
                        ...
                        <div class="collapse navbar-collapse " id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto navbar-right-top">
                                <li class="nav-item"> 
                                    <a  style="color:#FFFFFF;" class="nav-link" href="<?php echo e(route('AllBoardings')); ?>" id="navbarDropdown" role="button"  aria-haspopup="true" ><i class="fas fa-home"></i>&nbspFind Your Boarding</a> 
                                </li>
                                <li class="nav-item"> 
                                        <a style="color:#FFFFFF;" class="nav-link" href="#toprated" data-value="toprated" id="navbarDropdown" role="button"  aria-haspopup="true" ><i class="fas fa-smile"></i>&nbspTop Rated</a> 
                                    </li>
                                <li class="nav-item"> 
