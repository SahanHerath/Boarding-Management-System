                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nicno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nicno" type="text" class="form-control" name="nicno" value="<?php echo e(old('nicno')); ?>"  autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="<?php echo e(old('address')); ?>"  autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('contactno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="contactno" type="text" class="form-control" name="contactno" value="<?php echo e(old('contactno')); ?>"  autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php endif; ?>
                                <p id = "passwordHelpBloack" class = "form text-muted">
                                    Your password must be more than 6 characters long, should contain at-least 1 Uppercase,
