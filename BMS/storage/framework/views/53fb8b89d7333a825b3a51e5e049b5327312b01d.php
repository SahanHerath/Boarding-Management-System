        ...
        <div class=" col-md-10 col-md-offset-1 "> 
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <td><h4><form action= "<?php echo e(route('boarding.create')); ?>" method = get>
                        <?php echo e(csrf_field()); ?>

                        <input type ="Submit" value = "Add New Boarding" >
                    </form></h4></td></tr>
                        ...
                        <?php $__currentLoopData = $boardings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $boarding): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <tr>
                          ...
                          <td><h4><form action= "<?php echo e(route('boarding.edit',$boarding->id)); ?>"  method = "get">
