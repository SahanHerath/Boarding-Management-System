                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('user.update',$user->id)); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nicno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nicno" type="text" class="form-control" name="nicno" value="<?php echo e($user->nicno); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="<?php echo e($user->address); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('contactno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="contactno" type="text" class="form-control" name="contactno" value="<?php echo e($user->contactno); ?>" required autofocus>
