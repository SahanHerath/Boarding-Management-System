    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-3 col-md-5 col-sm-12 col-12">
            ...
            <div class="card-body border-top ">
                ...
                <a href="<?php echo e(URL('/changePassword')); ?>" title="change your account password"><button class="btn btn-warning" >Change Password</button></a> 
                                    ...
                                    <div class="media influencer-profile-data d-flex align-items-center p-2">
                                        <div class="media-body ">
                                            <div class="influencer-profile-data">
                                                ...
                                                <td>
                                                <div class=offset-10>
                                                <?php if($boarding->available==1): ?>
                                                <h4><a href="<?php echo e(URL('/unAvailable'.$boarding->id)); ?>"><button type="button" style="background-color:black" class="btn btn-success">Make Unavailble</button></a></h4>
                                                <?php endif; ?>

                                                <?php if($boarding->available==0): ?>
                                                <h4><a href="<?php echo e(URL('/Available'.$boarding->id)); ?>"><button type="button" style="background-color:black" class="btn btn-success">Make Availble</button></a></h4>
