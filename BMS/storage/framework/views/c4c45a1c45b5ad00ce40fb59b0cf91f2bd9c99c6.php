    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="panel panel-default p-3 mb-2">
                        ...
                        <div class="text-dark">
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-2"><i class="fas fa-star"></i> Rating :- <?php echo e($att->rate); ?>/5</li>
                                <br>
                                <br><a href="<?php echo e(URL('/viewBoarding'.$att->id)); ?>" ><div align="right"><button type="button" class="btn btn-dark">View Boarding</button></div><a>
                            </ul>
                        </div>
